    ...
    switch (sUriMatcher.match(uri)) {
      ...
      case CODE_WEATHER_WITH_DATE: {
        ...
        cursor = mOpenHelper.getReadableDatabase().query(
            ...
            projection,
                         ...
                         */
            WeatherContract.WeatherEntry.COLUMN_DATE + " = ? ", selectionArguments, null, null,
            sortOrder);
      ...
      case CODE_WEATHER: {
        cursor = mOpenHelper.getReadableDatabase()
            .query(WeatherContract.WeatherEntry.TABLE_NAME, projection, selection, selectionArgs,
                null, null, sortOrder);
    ...
    switch (sUriMatcher.match(uri)) {
      ...
      case CODE_WEATHER_WITH_DATE:
        ...
        deletedRows = db.delete(WeatherContract.WeatherEntry.TABLE_NAME,
            WeatherContract.WeatherEntry.COLUMN_WEATHER_ID + " = " + itemId, selectionArgs);
        break;
      default:
    }
    return deletedRows;
