...
public class WeatherProvider extends ContentProvider {
  ...
  @Override public Cursor query(@NonNull Uri uri, String[] projection, String selection,
    ...
    switch (match) {
      case CODE_WEATHER:
        outputCursor =
            db.query(WeatherContract.WeatherEntry.TABLE_NAME, null, selection, selectionArgs, null,
                null, sortOrder);
        break;
      case CODE_WEATHER_WITH_DATE:
        ...
        outputCursor =
            db.query(WeatherContract.WeatherEntry.TABLE_NAME, null, selection, selectionArgs, null,
                WeatherContract.WeatherEntry.COLUMN_DATE + "=" + date, sortOrder);
        break;
      default:
        throw new UnsupportedOperationException("no action for uri: " + uri);
    }
    outputCursor.setNotificationUri(getContext().getContentResolver(), uri);
    return outputCursor;
  }
